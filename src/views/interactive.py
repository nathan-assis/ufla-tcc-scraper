...
def render_graph_interactive(graphs_dict, layout: str = "spring"):
    ...
    def create_figure(graph, highlight_node=None):
    ...
    app.layout = html.Div([
        ...
        dcc.Graph(id="graph", figure=create_figure(first_graph)),
    ])
    ...
    def update_graph(selected_graph, clickData):
        ...
        return create_figure(graph, highlight_node)
